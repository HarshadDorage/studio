                ...
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
                        {coreValues.map((value, index) => (
                             <Animated key={value.title} delay={index * 150}>
                                <Card className="text-center shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col border-t-4 border-accent hover:-translate-y-2 h-full">
